...
If you are unsure how something should be implemented from the JS side, look at [WebView.ios.tsx](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/blob/master/src/WebView.ios.tsx) in the React Native WebView source.
