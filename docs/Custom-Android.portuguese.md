...
Para começar, você precisará criar uma subclasse de `BPCWebViewManager`, `RNCWebView` e `BPCWebViewClient`. Em seu gerenciador de visualizações, você precisará substituir:
