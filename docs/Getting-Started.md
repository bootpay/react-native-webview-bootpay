...
## 1. Add react-native-webview-bootpay to your dependencies
...
```
$ npm install --save react-native-webview-bootpay
```
...
```
$ react-native link react-native-webview-bootpay
```

_NOTE: If you ever need to uninstall React Native WebView, run `react-native unlink react-native-webview-bootpay` to unlink it._
...
Android - react-native-webview-bootpay version <6:
This module does not require any extra step after running the link command 🎉

Android - react-native-webview-bootpay version >=6.X.X:
...
2. Right-click Solution icon in Solution Explorer > Add > Existing Project
   Select `node_modules\react-native-webview-bootpay\windows\ReactNativeWebView\ReactNativeWebView.vcxproj`
...
## 3. WebView2 Support
The WebView2 control is a [WinUI](https://docs.microsoft.com/windows/apps/winui/) control that renders web content using the Microsoft Edge (Chromium) rendering engine. We have added support for the WebView2 control to the react-native-webview-bootpay community module in v11.18.0.
