...
![star this repo](https://img.shields.io/github/stars/react-native-webview-bootpay/react-native-webview-bootpay?style=flat-square)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![NPM Version](https://img.shields.io/npm/v/react-native-webview-bootpay.svg?style=flat-square)](https://www.npmjs.com/package/react-native-webview-bootpay)
![Npm Downloads](https://img.shields.io/npm/dm/react-native-webview-bootpay.svg)
...
Importez le composant `WebView` de `react-native-webview-bootpay` et utilisez le de la manière suivante :
...
- Si l'erreur `Invariant Violation: Native component for "BPCWebView does not exist"` intervient, cela signifie probablement que vous avez oublié d'executer `react-native link` ou qu'une erreur est intervenue durant le processus de liaison.
- Si vous rencontrer une erreur de build durant l'execution de la tâche `:app:mergeDexRelease`, vous devez activer le support du multidex dans `android/app/build.gradle` comme discuté [ici](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/issues/1344#issuecomment-650544648)

## Contribuer

Voir [Contributing.md](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/blob/master/docs/Contributing.md)
