...
![Dai una stella a questo repo](https://img.shields.io/github/stars/react-native-webview-bootpay/react-native-webview-bootpay?style=flat-square&label=stelle)
[![PRs gradite](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![Versione NPM](https://img.shields.io/npm/v/react-native-webview-bootpay.svg?style=flat-square)](https://www.npmjs.com/package/react-native-webview-bootpay)
![NPM Downloads mensili](https://img.shields.io/npm/dm/react-native-webview-bootpay.svg)
...
### Utilizzo
Importa il componente `WebView` da `react-native-webview-bootpay` per poi usarlo nel seguente modo:
...
### Problemi comuni
- Se riscontri `Invariant Violation: Native component for "BPCWebView does not exist"`, probabilmente significa che hai dimenticato di eseguire `react-native link` o c'è stato qualche errore durante il processo di collegamento.
- In caso di un errore di compilazione durante l'operazione `:app:mergeDexRelease`, devi abilitare il supporto multidex in `android/app/build.gradle`, come discusso in [questa issue](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/issues/1344#issuecomment-650544648).
