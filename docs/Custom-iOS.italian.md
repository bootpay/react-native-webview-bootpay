...
Se non sei sicuro su come qualcosa debba essere implementato nel lato JS, dai un'occhiata al file [WebView.android.tsx](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/blob/master/src/WebView.ios.tsx) nel codice sorgente di React Native WebView.
