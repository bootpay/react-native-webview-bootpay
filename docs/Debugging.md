...
1. Mark the WebView as being "inspectable" using the [`webviewDebuggingEnabled`](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/blob/master/docs/Reference.md#webviewDebuggingEnabled) prop
...
1. You will need to set the [`webviewDebuggingEnabled`](https://github.com/react-native-webview-bootpay/react-native-webview-bootpay/blob/master/docs/Reference.md#webviewDebuggingEnabled) prop on the WebView
